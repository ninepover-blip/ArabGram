...
var postgresAuthorizationDelivery store.DeliveryEffectsBuilder[store.AuthorizationDeliverySnapshot] = func(snapshot store.AuthorizationDeliverySnapshot) ([]store.DeliveryEffect, error) {
